...
public class SwitchPattersnUseCase {

	public static void main(String[] args) {
		System.out.println("Demonstrating conversion to double using if-statement::");
		...
		System.out.println("Demonstrating conversion to double using type pattern::");
		...
		System.out.println("Demonstrating conversion to double using guarded pattern::");
		...
		System.out.println("Demonstrating conversion to double using paranthesized pattern::");
